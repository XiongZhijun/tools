 ...
 */
package org.herod.simpleweather.widgets;
...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private final OnClickListener mTabClickListener = new OnClickListener() {
		public void onClick(View view) {
			...
			if (view instanceof Indexable) {
				newSelected = ((Indexable) view).getIndex();
			} else {
				newSelected = view.getId();
			}
	...
	protected void addTab(int index, CharSequence text, int iconResId) {
		View tabView = createTabView(index, text, iconResId);
		tabView.setOnClickListener(mTabClickListener);
		if (tabView instanceof Indexable) {
			((Indexable) tabView).setIndex(index);
		} else {
			tabView.setId(index);
		}
	...
	protected class TabView extends TextView implements Indexable {
